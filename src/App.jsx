        ...
        <nav className="bg-white shadow-md sticky top-0 z-50">
          <div className="max-w-7xl mx-auto px-2 sm:px-4">
            <div className="flex justify-center space-x-1 sm:space-x-4 md:space-x-8">
              ...
              <button onClick={() => setActiveView('actuarial')} className="py-3 px-2 sm:px-4 md:px-6 text-xs sm:text-sm md:text-base text-blue-600 border-b-2 border-blue-600 transition-all font-semibold"><span className="hidden sm:inline">🧮 Actuaría</span><span className="sm:hidden">🧮 Actuaría</span></button>
            </div>
          </div>
        </nav>
        <div className="max-w-7xl mx-auto px-4 py-10">
